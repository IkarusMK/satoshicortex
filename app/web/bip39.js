/* BIP39, englische Wortliste — die 2048 Woerter, aus denen ein Seed besteht.
 *
 ...
 *
 * HERKUNFT: bitcoin/bips, bip-0039/english.txt. Geprueft am 11.09.2026 —
 * SHA-256 2f5eed53a4727b4bf8880d8f3f199efc90e58503646d9ff8eff3a2ed3b24dbda,
 * genau die Summe, die BIP39 selbst nennt. 2048 Woerter, sortiert,
 * eindeutig, durchgehend kleine ASCII-Buchstaben.
 *
 * aezeed (LNDs Seed-Format) ist NICHT BIP39 — es benutzt aber dieselbe
 * Wortliste. Die Pruefung hier stellt also genau die Frage, die LND auch
 * stellt, nur frueher.
 *
 * Gemeinfrei wie BIP39 selbst.
 */
"use strict";
...
certain chair chalk champion change chaos chapter charge chase chat cheap
check cheese chef cherry chest chicken chief child chimney choice choose
chronic chuckle chunk churn cigar cinnamon circle citizen city civil claim
clap clarify claw clay clean clerk clever click client cliff climb clinic
...
kitchen kite kitten kiwi knee knife knock know lab label labor ladder lady
lake lamp language laptop large later latin laugh laundry lava law lawn
lawsuit layer lazy leader leaf learn leave lecture left leg legal legend
...
pulp pulse pumpkin punch pupil puppy purchase purity purpose purse push
...
shaft shallow share shed shell sheriff shield shift shine ship shiver
shock shoe shoot shop short shoulder shove shrimp shrug shuffle shy
...
skull slab slam sleep slender slice slide slight slim slogan slot slow
slush small smart smile smoke smooth snack snake snap sniff snow soap
soccer social sock soda soft solar soldier solid solution solve someone
...
wrestle wrist write wrong yard year yellow you young youth zebra zero zone
zoo
`.trim().split(/\s+/);

const BIP39_SATZ = new Set(BIP39);
